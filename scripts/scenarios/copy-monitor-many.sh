...
timeout 2 barf -w 132 copy $TMPDIR/local/* $TMPDIR/remote1/
echo "^C"
prompt 'barf copy ~/local/* ~/remote2/'
timeout 2 barf -w 132 copy $TMPDIR/local/* $TMPDIR/remote2/
echo "^C"
prompt 'barf copy ~/local/* ~/remote3/'
timeout 2 barf -w 132 copy $TMPDIR/local/* $TMPDIR/remote3/
echo "^C"
